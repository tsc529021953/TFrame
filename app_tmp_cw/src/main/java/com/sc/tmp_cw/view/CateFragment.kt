...
import com.sc.tmp_cw.databinding.FragmentCateBinding
import com.sc.tmp_cw.databinding.FragmentTravelBinding
import com.sc.tmp_cw.vm.CateViewModel
 ...
 * @description
 */
class CateFragment: BaseBindingFragment<FragmentCateBinding, CateViewModel>(), FileImgAdapter.FileImgCallback {

    override var layoutId: Int = R.layout.fragment_cate

    @Inject
    override lateinit var viewModel: CateViewModel
