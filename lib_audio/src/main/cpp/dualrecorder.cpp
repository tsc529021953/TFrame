...
Java_com_sc_audio_DualRecorderJNI_initRecorder(
        JNIEnv* env,
        jclass clazz,
        jstring devicePath,
        jint sampleRate,
...
Java_com_sc_audio_DualRecorderJNI_startRecording(
        JNIEnv* env,
        jclass clazz,
        jlong recorderPtr,
        jstring filePath) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_sc_audio_DualRecorderJNI_stopRecording(
        JNIEnv* env,
        jclass clazz,
        jlong recorderPtr) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_sc_audio_DualRecorderJNI_releaseRecorder(
        JNIEnv* env,
        jclass clazz,
        jlong recorderPtr) {
    ...
    if (recorder->is_recording) {
        Java_com_sc_audio_DualRecorderJNI_stopRecording(env, clazz, recorderPtr);
    }
