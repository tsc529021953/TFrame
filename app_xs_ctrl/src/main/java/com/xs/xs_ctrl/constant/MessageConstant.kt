package com.xs.xs_ctrl.constant
...
object MessageConstant {
    ...
    const val SP_PORT3 = "SP_PORT3"
    var ip = "192.168.1.232" // 192.168.1.232 192.168.1.105
    var ip2 = "192.168.1.233" // 192.168.1.233
    var port = 10000
    var port2 = 1000
    var port3 = 60000
    ...
    const val AI_MEDIA_02 = "192.168.1.102"
    const val AI_MEDIA_03 = "192.168.1.103"
    const val AI_MEDIA_04 = "192.168.1.104"
    const val AI_MEDIA_05 = "192.168.1.105"
    const val AI_MEDIA_06 = "192.168.1.106"
    const val AI_MEDIA_07 = "192.168.1.107"
}