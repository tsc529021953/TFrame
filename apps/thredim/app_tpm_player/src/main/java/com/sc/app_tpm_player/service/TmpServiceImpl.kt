package com.sc.app_tpm_player.service
...
import com.sc.app_tpm_player.R
import com.sc.app_tpm_player.constant.MessageConstant
import com.sc.app_tpm_player.inter.ITmpService
...
////                    Timber.i("TTAG json $json ${applist.size}")
////                    for (i in 0 until applist.size) {
////                        val app = applist[i]
////                        if (i < AppList.size) {
////                            AppList[i].name = app.name
////                        }
////                        Timber.i("TTAG app $app")
////                    }
//                    callback.invoke()
//                } else {
//                    copyFun.invoke()
