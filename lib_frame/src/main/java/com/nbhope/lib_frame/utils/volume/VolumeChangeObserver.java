package com.nbhope.lib_frame.utils.volume;
...
public class VolumeChangeObserver {
    ...
    private static final String STREAM_MUTE_CHANGE  = "android.media.STREAM_MUTE_CHANGED_ACTION";
    ...
    public void registerReceiver() {
        ...
        filter.addAction(STREAM_MUTE_CHANGE);
    ...
    private static class VolumeBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Timber.i("onVolumeChange onReceive " + intent.getAction());
            //媒体音量改变才通知
            if ((VOLUME_CHANGED_ACTION.equals(intent.getAction()) || STREAM_MUTE_CHANGE.equals(intent.getAction()))
