...
public class NotificationUtils extends ContextWrapper {
    ...
    public void sendNotificationFullScreen( String title, String content, String type, Class<?> cls, int icon) {
        if (Build.VERSION.SDK_INT >= 26) {
            createNotificationChannel();
            Notification notification = getChannelNotificationQ
                    (title, content, type, cls, icon);
    ...
    public  Notification getChannelNotificationQ(String title, String content, String type, Class<?> cls, int icon) {
        Intent fullScreenIntent = new Intent(this, cls);
