...
public final class AppUtil {
     ...
     *
     * @param context
     * @param packageName          包名，比如cn.nbhope.threepartprotocol
     * @param LauncherActivityName Launcher Activity 类名，比如cn.nbhope.threepartprotocol.management.SplashActivity
     * @return
     */
    public static boolean launchOtherApp(Context context, String packageName, String LauncherActivityName) {
        try {
